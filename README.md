...
- **Credentials** — two Google learning records on Coursera: the Google AI Professional Certificate (seven courses, in progress; four completed) and the completed five-course Google AI Essentials specialization, each linking to its issuer’s verification pages.
